  ...
  >
    ...
    <div v-if="!gameStarted" class="start-screen">
      <div class="start-card">
        ...
        <p>
          Learn Rwanda's historical figures while solving puzzles.
        </p>
      ...
      <div class="board-wrapper">
        <div class="board">
          ...
          <div
            ...
            :class="{
              empty: tile === 0,
              'move-animation': lastMoveIndex === index
            }"
      ...
      >
        <div class="trophy-screen">
          ...
          <div class="level-stats">
            <p>Score Earned: {{ lastLevelScore }}</p>
            <p>Moves: {{ moveCount }}</p>
...
// ============================================================
import picture1 from '../assets/mutara.jpg'
import picture2 from '../assets/kanjogera.jpg'
import picture3 from '../assets/ndahindurwa.jpg'
import picture4 from '../assets/rosalie gicanda.jpg'
import picture5 from '../assets/ruganzu.jpg'
import picture6 from '../assets/kigeri v.jpg'
import picture7 from '../assets/kagame.jpg'
import picture8 from '../assets/habyarimana.jpg'
import picture9 from '../assets/kayibanda.jpg'
import picture10 from '../assets/images.jpg'
...
export default {
  ...
  return {
    ...
    facts: [
      "King Kigeli V Ndahindurwa was the last king of Rwanda.",
      "Agathe Uwilingiyimana was Rwanda's first female Prime Minister.",
      "Mutara III Rudahigwa helped modernize Rwanda.",
      "Alexis Kagame was a famous historian.",
      "Rosalie Gicanda was the last queen of Rwanda.",
      "Ruganzu Ndoli expanded the Rwandan kingdom.",
      "Felicite Niyitegeka saved lives during the genocide.",
      "Kanjogera played a major role in the royal court.",
      "Yuhi V Musinga ruled from 1896 to 1931.",
      "Historical figures help us understand Rwanda's past."
    ],
